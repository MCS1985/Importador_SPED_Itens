...
ORDER BY
 ...
 ====================================================================================
   /*OPCIONAL — Exportar para CSV/Excel.
   Para gerar arquivo, comente o ";" acima e descomente o COPY abaixo:
   ====================================================================================*/

COPY (
    -- cole aqui (sem o ; final) toda a consulta acima a partir do "WITH CFOP_NAT_BC_CRED"
